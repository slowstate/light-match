...
@onready var left_leg_particle: GPUParticles2D = $LeftLegParticle
@onready var right_leg_particle: GPUParticles2D = $RightLegParticle
...
func _ready() -> void:
	...
	left_leg_particle.emitting = true
	right_leg_particle.emitting = true
